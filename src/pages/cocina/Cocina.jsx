...
// Formato compacto "Etiqueta: valores" para el modal "Ver detalle" (la
// tarjeta de la lista no usa esto, se quedó en su formato original de chips).
// Se distingue la columna `salsas` según el tipo de producto: en un producto
// es_bowl esa columna guarda su Cobertura elegida (negro/blanco/arequipe), no
// untables reales -- ver Catalogo.jsx donde se arma el pedido
...
function LineaCompacta({ label, valor }) {
  ...
  return (
    <div style={{ fontSize: 13, color: '#333', marginBottom: 3, lineHeight: 1.4 }}>
      <span style={{ color: COLOR_CATEGORIA[label] || '#666', marginRight: 5, fontSize: 10 }}>●</span>
