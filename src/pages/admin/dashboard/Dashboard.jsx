...
import { DollarSign, ShoppingCart, Truck, CreditCard, Clock, TrendingUp, Star, Power, CalendarClock, Wallet, Plus, Trash2, Printer } from 'lucide-react';
              ...
              <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: 13 }}>
                <thead>
                  <tr style={{ borderBottom: '2px solid #f0f0f0' }}>
                    {['Domiciliario','Entregas','Efectivo','Transferencia','Datáfono','Total','Total envíos'].map((h) => (
                ...
                <tbody>
                  {domiciliarios.map((d) => (
                    <tr key={d.nombre} style={{ borderBottom: '1px solid #f5f5f5' }}>
                      ...
                      <td style={{ padding: '10px 12px', color: '#c2410c', fontWeight: 700 }}>${Number(d.datafono || 0).toLocaleString('es-CO')}</td>
